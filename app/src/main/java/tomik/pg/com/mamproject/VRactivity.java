...
public class VRactivity extends GvrActivity implements GvrView.StereoRenderer {
    ...
    private static final String[] OBJECT_VERTEX_SHADER_CODE =
            new String[]{"uniform mat4 u_MVP;", "attribute vec4 a_Position;",
                    "attribute vec2 a_UV;", "varying vec2 v_UV;", "", "void main() {",
                    "  v_UV = a_UV;", "  gl_Position = u_MVP * a_Position;", "}",};
    private static final String[] OBJECT_FRAGMENT_SHADER_CODE =
            new String[]{"precision mediump float;", "varying vec2 v_UV;",
    ...
    public void onSurfaceCreated(EGLConfig config) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                gvrAudioEngine
                        .setSoundObjectPosition(sourceId, targetPosition[0], targetPosition[1],
                                targetPosition[2]);
        ...
        try {
            ...
            targetObjectMeshes.add(new TexturedMesh(this, "Icosahedron.obj", objectPositionParam,
                    objectUvParam));
            targetObjectNotSelectedTextures
                    .add(new Texture(this, "Icosahedron_Blue_BakedDiffuse.png"));
            targetObjectSelectedTextures
                    .add(new Texture(this, "Icosahedron_Pink_BakedDiffuse.png"));
            targetObjectMeshes.add(new TexturedMesh(this, "QuadSphere.obj", objectPositionParam,
                    objectUvParam));
            targetObjectNotSelectedTextures
                    .add(new Texture(this, "QuadSphere_Blue_BakedDiffuse.png"));
            targetObjectSelectedTextures.add(new Texture(this, "QuadSphere_Pink_BakedDiffuse.png"));
            targetObjectMeshes.add(new TexturedMesh(this, "TriSphere.obj", objectPositionParam,
                    objectUvParam));
            targetObjectNotSelectedTextures
                    .add(new Texture(this, "TriSphere_Blue_BakedDiffuse.png"));
    ...
    private void updateTargetPosition() {
        ...
        if (sourceId != GvrAudioEngine.INVALID_ID) {
            gvrAudioEngine.setSoundObjectPosition(sourceId, targetPosition[0], targetPosition[1],
                    targetPosition[2]);
        }
    ...
    public void onNewFrame(HeadTransform headTransform) {
        ...
        gvrAudioEngine.setHeadRotation(headRotation[0], headRotation[1], headRotation[2],
                headRotation[3]);
    ...
    private void hideTarget() {
        ...
        targetDistance = random.nextFloat() * (MAX_TARGET_DISTANCE - MIN_TARGET_DISTANCE) +
                MIN_TARGET_DISTANCE;
